                    ...
                    <div class="container popUp">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-md-8">
                                <form class="bg-gradient bg-light rounded shadow-5-strong p-5" action="update.php?produto_id=<?= $produtos['produto_id']?>" method="POST">
                                    <h1 class="text-center pb-3"><b>Editar produto</b></h1>
                                    <hr />
