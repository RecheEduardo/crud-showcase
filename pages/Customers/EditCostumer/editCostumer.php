                    ...
                    <div class="container popUp">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-md-8">
                                <form class="bg-gradient bg-light rounded shadow-5-strong p-5" action="edit.php?id=<?= $clientes['id']?>" method="POST">
                                    <h1 class="text-center pb-3"><b>Editar cliente</b></h1>
                                    <hr />
                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <label class="form-label" for="clientes[nome]">Nome</label>
                                        <input type="text" id="nome" name="clientes[nome]" class="form-control" placeholder="Digite seu nome..." value = '<?= $clientes['nome'] ?>'/>
                                    </div>

                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <label class="form-label" for="idade">Idade</label>
                                        <input type="number" id="idade" name="clientes[idade]" class="form-control" placeholder="Digite sua idade..." value='<?= $clientes['idade'] ?>'/>
                                    </div>

                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <label class="form-label" for="email">Email</label>
                                        <input type="email" id="email" name="clientes[email]" class="form-control" placeholder="Digite seu E-Mail..." value='<?= $clientes['email'] ?>'/>
                                    </div>
