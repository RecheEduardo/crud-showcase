...
$id_sql = "SELECT * FROM pedidos where pedido_id = $id";

$id_result = $connection->query($id_sql);

if (!$id_result) {
    die("Erro na consulta: " . $connection->error);
}

$pedido = $id_result->fetch_assoc();
                    ...
                    <div class="container fadeInUp">
                        <div class="row justify-content-center">
                            <div class="col-xl-5 col-md-8">
                                <form class="bg-gradient bg-light rounded shadow-5-strong p-5" action="./editar.php?pedido_id=<?= $pedido['pedido_id']?>" method="POST">
                                    <h1 class="text-center pb-3 text-dark"><b>Editar pedido</b></h1>
                                    <hr>
                                    ...
                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        ...
                                        <input type="number" id="quantidade" name="pedidos[produto_quantidade]" class="form-control" placeholder="Digite a quantidade..." min="1" required value="<?= $pedido['produto_quantidade']?>"/>
                                    </div>

                                    <div class="form-outline mb-4" data-mdb-input-init>
                                        <label class="form-label" for="endereco">Endereço completo</label>
                                        <input type="text" id="endereco" name="pedidos[endereco_pedido]" class="form-control" placeholder="Digite o endereço do pedido..." required value="<?= $pedido['endereco_pedido'] ?>"/>
                                    </div>
