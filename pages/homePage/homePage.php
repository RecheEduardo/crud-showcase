          ...
          <div class="card mb-5 fadeInUp" style="border: none !important">
            <div class="card-body">
              <div class="container d-flex gap-5 justify-content-between align-items-center popIn" style='height: 80svh;'>
                ...
                <button class="btn bg-gradient bg-info p-5 options-btn">
                  <a href="../Customers/costumersList/costumersList.php" class='text-light text-decoration-none d-flex gap-3 display-4'>
                    <i class="fa-regular fa-user"></i>Clientes
                  </a>
                </button>
                <button class="btn bg-gradient bg-info p-5 options-btn">
                  <a href="../Products/productsList/productsList.php" class='text-light text-decoration-none d-flex gap-3 display-4'>
                    <i class="fa-solid fa-cart-shopping"></i>Produtos
                  </a>
                </button>
                <button class="btn bg-gradient bg-info p-5 options-btn">
                  <a href="../Orders/ordersList/ordersList.php" class='text-light text-decoration-none d-flex gap-3 display-4'>
